...
#This function is called when a new message is received from sns on lambda handler and then this function will call construct_message_voxcatalog function to store the eventtype of SES message.
def construct_message_voxcatalog(message, wcnx):
